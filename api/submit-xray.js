module.exports = async function handler(req, res) {
  ...
  const cf = [
    ...
    ['pillar_opportunity__ops',       p.pillar_ops],
    ['pillar_opportunity__revenue',   p.pillar_rev],
    ['pillar_opportunity__financial', p.pillar_fin],
    ['pillar_opportunity__team',      p.pillar_team],
